...
#ifndef __LOCAL_PATCH_SOLVER_H
#define __LOCAL_PATCH_SOLVER_H
...
namespace dolfin
{
  ...
  /// up repeated applications of the LocalPatchSolver with the same
  ...
  public:
    ...
    void solve_global_rhs(std::vector<Function*> u) const;
    ...
    void solve_local_rhs(std::vector<Function*> u) const;
    ...
    void solve_local(std::vector<GenericVector*> x,
  ...
  private:
    ...
    std::vector<std::shared_ptr<const Form>> _a, _formL;
