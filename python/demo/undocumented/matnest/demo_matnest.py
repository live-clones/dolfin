...
A00 = PETScMatrix()
assemble(a00,tensor=A00)

A01 = PETScMatrix()
assemble(a01,tensor=A01)

A10 = PETScMatrix()
assemble(a10,tensor=A10)
...
# Combine matrices
listA=[A00,A01,A10,None]
print(type(listA))

AA = PETScNestMatrix(listA)
