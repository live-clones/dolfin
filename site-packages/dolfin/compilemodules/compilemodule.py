...
def compile_extension_module(code, module_name="",
    ...
    *Examples of usage*
    ...
    dolfin.info("Calling DOLFIN JIT here")
...
%inline %{""" + cpp_code + "\n%}"
    ...
    print(temp_dir)
    temp_cpp = temp_dir + "/tempfile.cpp"
    temp_i = temp_dir + "/tempfile.i"
    temp_so = temp_dir + "/tempfile.so"
    f = open(temp_i,"w")
    f.write(swig_code)
    f.close()
    header_location="-I/usr/include/python3.5 -I"+ffc.get_include_path()+" -I"+dolfin.get_include_path()
