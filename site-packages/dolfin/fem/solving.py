...
class LocalPatchSolver(cpp.LocalPatchSolver):
    ...
    def __init__(self, a, L=None, solver_type=cpp.LocalPatchSolver.SolverType_LU):
        ...
        if L is None:
            # Initialize C++ base class
            cpp.LocalPatchSolver.__init__(self, a, solver_type)
        else:
            L = [Form(Li) if not Li.empty() else cpp.form(1, 0) for Li in L]

            # Initialize C++ base class
            cpp.LocalPatchSolver.__init__(self, a, L, solver_type)
