...
def norm(v, norm_type="L2", mesh=None):
    ...
    *Examples of usage*
    ...
    # If vector, return vector norm
    if isinstance(v, GenericVector):
        return v.norm(norm_type.lower())

    # If function, return integral norm
    if (isinstance(v, Coefficient) and isinstance(v, GenericFunction)):
        ...
        if norm_type.lower() == "linf":
            if isinstance(v, Function):
                ...
                cpp.dolfin_error("norms.py",
                                "compute norm",
                                "Infinity not supported for Expressions.")
...
def errornorm(u, uh, norm_type="l2", degree_rise=3, mesh=None):
    ...
    *Arguments*
    ...
    if degree_u is not None and \
      degree_u < degree and \
      not norm_type.lower() == 'linf':
