...
class Function(ufl.Coefficient, cpp.Function):
    ...
    *Examples*
    ...
    def sub(self, i, deepcopy=None):
        ...
        *Arguments*
        ...
        if deepcopy is not None:
            cpp.deprecation("'deepcopy' keyword argument of Function.sub()",
                            "2017.2.0",
                            "Use just Function.sub(i).copy() for deep copy")
    ...
    def split(self, deepcopy=None):
        ...
        *Arguments*
            deepcopy
                DEPRECATED: If True coopy sub function vector
                instead of sharing, if None or False return view
                into original function
        """
        if deepcopy is not None:
            cpp.deprecation("'deepcopy' keyword argument of Function.split()",
                            "2017.2.0",
                            "Use Function.copy() for deep copy")
