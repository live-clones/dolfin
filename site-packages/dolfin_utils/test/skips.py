...
xfail_with_serial_hdf5_in_parallel = pytest.mark.xfail(MPI.size(mpi_comm_world()) > 1 and not has_hdf5_parallel(), reason="Serial HDF5 library cannot work in parallel.")
skip_in_parallel = pytest.mark.skipif(MPI.size(mpi_comm_world()) > 1,
                                      reason="This test should only be run in serial.")
skip_with_serial_hdf5_in_parallel = pytest.mark.skipif(MPI.size(mpi_comm_world()) > 1 and not has_hdf5_parallel(), reason="Serial HDF5 library cannot work in parallel.")
